...
<body>
    ...
    <div class="centro">
        <div class="login">
            ...
            <div class="alerta" style=" padding: 0px 10px; margin-bottom: 20px;">
                ...
                <p>Conta registrada com sucesso! Agora faça login.</p>
            </div>
            <?php } ?>
            ...
            <p><a href="registro.php">Não tem uma conta? Registre-se</a></p>
            <?php if($mensagem == 1) {?>
            <div class="alerta" style="background-color: #FFD6D6; border-color: #FF4D4D; padding: 0px 10px;">
                ...
                <p>Senha incorreta! Verifique o Caps-Lock.</p>
            </div>
            <?php } if($mensagem == 2) { ?>
            <div class="alerta" style="background-color: #FFD6D6; border-color: #FF4D4D; padding: 0px 10px;">
                <svg width="20px" height="20px" viewBox="-0.5 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
